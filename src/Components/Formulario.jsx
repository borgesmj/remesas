...
const Formulario = ({ setFormulario, setCalculator, monto }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if ([nombre, banco, documento, cuenta].includes("")) {
      ...
      if (
        window.confirm(`Confirme los datos, por favor
  ...
  return (
    <div id="salida" className="Formulario-salida">
      <div className="cerrar">
        <IoIosCloseCircleOutline className="closeBtn" onClick={handleClick} />
      </div>
