...
const Guide = ({currStep, currStepMessage}) => {
  ...
  return (
    <div className="w-full h-12 flex flex-col items-center justify-around py-8 my-4 relative">
      <div className="w-full h-1 border-[#4295e7] border-solid border-[4px] -z-10 absolute top-10"></div>
      <div className="flex flex-row items-center justify-around w-full mt-8 lg:mt-12">
